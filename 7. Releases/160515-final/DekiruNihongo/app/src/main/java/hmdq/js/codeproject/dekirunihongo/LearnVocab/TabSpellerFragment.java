        ...
        edtTuSpell.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    STrim sTrim = new STrim(edtTuSpell.getText().toString());
                        ...
                        if (checkEditSpell) {
                            ...
                            if (checkLearn) {
                                ...
                                if (sAnswerSpell.equals(sTu[indexSpell])) {
                                    ...
                                    indexFinish++;
                                    progressBar.setProgress(indexFinish*100/sTuLength);
                                    tvNumFinish.setText(indexFinish*100/sTuLength + "%");
